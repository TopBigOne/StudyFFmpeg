...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        CommonUtils.copyAssetsDirToSDCard(this, "byteflow", externalStorageState);
    ...
    private void testInterStorage() {
        externalStorageState = getFilesDir().getAbsolutePath() + File.separator;
        Log.d(TAG, "testInterStorage: externalStorageState :" + externalStorageState);
